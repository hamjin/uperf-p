...
"
    ...
    cp -r $MODPATH/common/system.prop $MODPATH/system.prop
    cp -r $MODPATH/common/post-fs-data.sh $MODPATH/post-fs-data.sh
    cp -r $MODPATH/common/service.sh $MODPATH/service.sh
